function subplot_spec4x2ab(X1,Y1,X2,Y2,X1a,Y1a,X2a,Y2a,nplot)
%
...
loglog(X1a,Y1a,'MarkerSize',8,'LineWidth',1,'Color',[0 0 1],'linestyle','-.');
loglog(X2a,Y2a,'MarkerSize',8,'LineWidth',1,'Color',[1 0 0],'linestyle','-.');
a1 = 1.1*(.25^4);
a2 = 1.1*(.25^5);
